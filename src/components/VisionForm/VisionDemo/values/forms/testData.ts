...
export const testData3: VisionFormValues = {
	...
	leases: [
		{
			...
			trafficTurnoverTimeLow: 10,
			trafficTurnoverTimeAverage: 10,
			trafficTurnoverTimeHigh: 10,
			maxOccupancyLow: 573,
			maxOccupancyAverage: 573,
			maxOccupancyHigh: 573,
	...
	products: [
		{
			locationIds: new Set(["72c3f1c6-a82b-4fda-b051-b822f51a3100"]),
			revenueRetailPriceLow: 150,
			revenueRetailPriceAverage: 150,
			revenueRetailPriceHigh: 150,
			revenueCostToProduceLow: 5,
			revenueCostToProduceAverage: 5,
			revenueCostToProduceHigh: 5,
